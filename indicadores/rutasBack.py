...
# Ruta COT
@server.route('/cot-data', methods=['GET'])
def cot_data():
...
#Ruta Desempleo
@server.route('/desempleo-data', methods=['GET'])
def desempleo_data():
    market = request.args.get('market', 'CAN')
    try:
...
#Ruta Tasas
@server.route('/tasas-data', methods=['GET'])
def tasas_data():
    market = request.args.get('market', 'CAN')
    try:
...
#Ruta Sentimiento
@server.route('/sentimiento-data', methods=['GET'])
...
#Ruta Pib
@server.route('/pib-data', methods=['GET'])
def pib_data():    
    market = request.args.get('market', 'CAN')
    try:
...
#Ruta correlacion
@server.route('/correlacion-data', methods=['GET'])
